...
''' Converting Miliseconds Unix Timestamp to Datetime Timestamp '''
...
times = {'Enchimento da panela':[],'Aquecedor ligar':[],'Aquecer Panela':[],'Encher Copo':[],'Despeja Copo':[]}
mean = []
...
for period in processes_periods[:-1]:
    ...
    time = time_aux - time
    times['Aquecedor ligar'].append(float('{}.{}'.format(time.seconds,time.microseconds)))
